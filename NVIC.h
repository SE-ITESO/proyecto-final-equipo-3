/**
	...
	\brief
		...
		It contains the declaration por some configuration functions and runtime functions.
	\author J. Luis Pizano Escalante, luispizano@iteso.mx
	\date	27/07/2015
	\todo
	    Pending interrupts and disable interrupts are not enable.
	@Function NVIC_INIT created by Pedro Fregoso & Andres Nuñez
 */
...
typedef enum {ALL, PRIORITY_1, PRIORITY_2, PRIORITY_3, PRIORITY_4, PRIORITY_5, PRIORITY_6,
